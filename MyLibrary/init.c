...
{/*
    ...
    GPIOPinTypeGPIOOutput(GPIO_PORT, GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3);
...
{/*
    HWREG(GPIO_PORT + GPIO_O_LOCK) = GPIO_LOCK_KEY;
    HWREG(GPIO_PORT + GPIO_O_CR) = SW2;
    GPIODirModeSet(GPIO_PORT, SW1 | SW2, GPIO_DIR_MODE_IN);
    GPIOPadConfigSet(GPIO_PORT, SW1 | SW2, GPIO_STRENGTH_2MA, GPIO_PIN_TYPE_STD_WPU);
   */ /////
